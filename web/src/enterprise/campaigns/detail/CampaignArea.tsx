        ...
        <Switch>
            <Route path={match.url} exact={true}>
                <CampaignDetails
                    {...props}
                    campaign={campaign}
                    _fetchPatchSetById={_fetchPatchSetById}
                    _queryPatchesFromCampaign={_queryPatchesFromCampaign}
                    _queryPatchesFromPatchSet={_queryPatchesFromPatchSet}
                    _queryPatchFileDiffs={_queryPatchFileDiffs}
                    _queryChangesets={_queryChangesets}
                />
            </Route>
